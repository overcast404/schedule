<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"D:\fastadmin\public/../application/index\view\calender\main.html";i:1556547604;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="row animated fadeInDown">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div id='external-events'>
                            ...
                            <div id="person">
                                <p>个人活动</p>
                                <?php if($userevent != 0): if(is_array($userevent) || $userevent instanceof \think\Collection || $userevent instanceof \think\Paginator): $i = 0; $__LIST__ = $userevent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$userevent): $mod = ($i % 2 );++$i;?>
                                <div class='external-event navy-bg' id="persont"><?php echo $userevent['title']; ?></div>
                                <?php endforeach; endif; else: echo "" ;endif; else: ?>
                                <div class='external-event navy-bg' >暂无</div>
                                <?php endif; ?>
                            ...
                            <hr>
                            <p>团队活动</p>
                            <?php if($teamevent != 0): if(is_array($teamevent) || $teamevent instanceof \think\Collection || $teamevent instanceof \think\Paginator): $i = 0; $__LIST__ = $teamevent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$teamevent): $mod = ($i % 2 );++$i;?>
                            <div class='external-event navy-bg'><?php echo $teamevent['title']; ?></div>
                            <?php endforeach; endif; else: echo "" ;endif; else: ?>
                                <div class='external-event navy-bg' >暂无</div>
                            <?php endif; ?>
                            <p class="m-t">
                                <hr>
                                <p>订阅号</p>
                                <?php if($pbevent != 0): if(is_array($pbevent) || $pbevent instanceof \think\Collection || $pbevent instanceof \think\Paginator): $i = 0; $__LIST__ = $pbevent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pbevent): $mod = ($i % 2 );++$i;?>
                                <div class='external-event navy-bg' id="pubilct"><?php echo $pbevent['title']; ?></div>
                                <?php endforeach; endif; else: echo "" ;endif; else: ?>
                                <div class='external-event navy-bg' >暂无</div>
                            <?php endif; ?>
                                <p class="m-t">
            ...
            <div class="col-sm-9">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>总日程表</h5>
                        <button class="btn btn-primary btn-sm ctrl pull-right" style="margin-top: -5px;">保存</button>
                    </div>
                    <div class="ibox-content">
                        <div id="calendar"></div>
                    </div>
