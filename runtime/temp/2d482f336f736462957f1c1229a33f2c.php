<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"D:\fastadmin\public/../application/index\view\team\board.html";i:1556247518;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="col-sm-4">
                <div class="ibox">
                    <div class="ibox-title">
                            ...
                            <?php endif; ?>
                        <h5><a href="<?php echo url('team/details',array('teamid'=>$team['id'])); ?>"><?php echo $team['name']; ?></a></h5>
                    </div>
