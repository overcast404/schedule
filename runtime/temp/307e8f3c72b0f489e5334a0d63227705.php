<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"D:\fastadmin\public/../application/index\view\calender\pb.html";i:1556295606;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title col-lg-3">
                        <h5>订阅号日程表</h5>
                        <select name="" id="publicSelect" class="form-control">
                            <option value="订阅号1">订阅号1</option>
                            <option value="订阅号2">订阅号2</option>
                            <option value="订阅号3">订阅号3</option>
                        </select>
                    </div>
