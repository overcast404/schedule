<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"D:\fastadmin\public/../application/index\view\form\user.html";i:1556333924;}*/ ?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="ibox">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-content">
                                ...
                                <form id="form" action="<?php echo url('form/user'); ?>" class="wizard-big"method="post">
