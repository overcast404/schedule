<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"D:\fastadmin\public/../application/index\view\pb\search.html";i:1556295605;}*/ ?>
<!DOCTYPE html>
<html>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="project-title">
                                            <a href="project_detail.html"><?php echo $pbres['name']; ?></a>
                                            <br />
                                            <small>创建于 <?php echo date("Y年m月d日 H:i:s",$pbres['time']); ?></small>
                                        </td>
                                        <td class="project-completion">
                                                <div class="team-members">
                                            <a href="#"><img alt="订阅号头像" class="img-circle" src="<?php echo $pbres['thumb']; ?>"></a>
                                            </div>
                                        </td>
                                        <td class="project-people">
                                            <a href="#"><img alt="管理员头像" class="img-circle"
                                                    src="<?php echo $pbres['admin']['avatar']; ?>"></a>
                                        </td>
                                        <td class="project-actions" id="more">
                                                <div class="btn btn-white btn-sm demo1" id="more" data-toggle="modal" data-target="#<?php echo $pbres['id']; ?>"><i
                                                        class="fa fa-folder"></i>
                                                    查看详情 </div>
    
                                            </td>
                                    </tr>
                                    <div class="modal inmodal" id="<?php echo $pbres['id']; ?>" tabindex="-1" role="dialog">
