<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"D:\fastadmin\public/../application/index\view\team\search.html";i:1556112632;}*/ ?>
<!DOCTYPE html>
<html>
                        ...
                        <div class="row m-b-sm m-t-sm">
                            ...
                            <div class="col-md-11">
                                <div class="input-group">
                                    <input type="text" placeholder="请输入团队号" name="number" class="input-sm form-control" value=" <?php echo $teamres['number']; ?>"required=""> <span
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="project-title">
                                            <a href="project_detail.html"><?php echo $teamres['name']; ?></a>
                                            <br />
                                            <small>创建于 <?php echo date("Y年m月d日 H:i:s",$teamres['uptime']); ?></small>
                                        </td>
                                        ...
                                        <td class="project-actions" id="more">
                                            <div class="btn btn-white btn-sm demo1" id="more" data-toggle="modal" data-target="#<?php echo $teamres['id']; ?>"><i
                                                    class="fa fa-folder"></i>
                                                查看详情 </div>

                                        </td>
                                    </tr>
                                    <div class="modal inmodal" id="<?php echo $teamres['id']; ?>" tabindex="-1" role="dialog">
