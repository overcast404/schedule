<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"D:\fastadmin\public/../application/index\view\pb\user.html";i:1555831795;}*/ ?>
<!DOCTYPE html>
<html>
                                            ...
                                            <table class="table table-striped table-hover">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>后端</td>
                                                        <td><i class="fa fa-certificate"></i>管理员</td>
                                                        <td class="client-status"><button
                                                                class="btn btn-warning btn-sm">降职</button>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="client-status"><button
                                                                class="btn btn-primary btn-sm">升职</button>
                                                        </td>
                                                        <td><button class="btn btn-danger btn-sm">赶走</button></td>
                                                    </tr>
