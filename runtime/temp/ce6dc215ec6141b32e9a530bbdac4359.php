<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"D:\fastadmin\public/../application/index\view\activity\index.html";i:1556547660;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="wrapper wrapper-content  animated fadeInRight blog">
            <div class="search-form">
                ...
                <div class="wrapper row">
                    <div class="topbar">
                        <label for=""><i class="fa fa-thumbs-up"></i>热门活动:</label>
                        <label class="label label-success"><a href="">计算机设计大赛</a></label>
                        <label class="label label-success"><a href="">互联网+</a></label>
                        <label class="label label-success"><a href="">多媒体设计大赛</a></label>
                        <label class="label label-success"><a href="">英语配音</a></label>
                        <label class="label label-success"><a href="">十佳歌手</a></label>
                        <label class="label label-success"><a href="">检查卫生</a></label>
                    </div>
                </div>
        <div class="row">
            <div class="col-lg-4">
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h5>标签：</h5>
                                <label class="label label-primary" type="button">Apple Watch</label>
                                <label class="label label-success" type="button">速比涛</label>
                            </div>
                            <div class="col-md-6">
