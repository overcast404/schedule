<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\fastadmin\public/../application/index\view\user\form_wizard-team.html";i:1554965655;}*/ ?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="ibox-content">
                                ...
                                <form id="form" action="form_wizard.html#" class="wizard-big">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <select name="" id="" class="form-control">
                                                    <option value="">团队1</option>
                                                    <option value="">团队2</option>
                                                </select>
                                            </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <input class="form-control layer-date" placeholder="请选择日期"
